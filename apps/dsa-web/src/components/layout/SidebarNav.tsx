...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Eye, Gauge, Home, Landmark, LogOut, MessageSquareQuote, Search, Settings2, TrendingUp } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'paper-trading', labelKey: 'layout.nav.paperTrading', to: '/paper-trading', icon: TrendingUp },
  { key: 'fixed-income', labelKey: 'layout.nav.fixedIncome', to: '/fixed-income', icon: Landmark },
  { key: 'observability', labelKey: 'layout.nav.observability', to: '/observability', icon: Eye },
